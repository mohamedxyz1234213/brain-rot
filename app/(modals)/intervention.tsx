...
const INTERVENTIONISTS = [
  { name: 'Dr. Amina', role: 'Psychologist', icon: 'medkit-outline', message: 'Your dopamine system is hijacked. Every scroll reinforces neural pathways that make the next scroll inevitable.' },
  { name: 'Coach Hassan', role: 'Discipline Coach', icon: 'barbell-outline', message: '3 bad days is a pattern. Patterns become habits. Habits become your identity. You\'re becoming the person who can\'t put the phone down.' },
  { name: 'Ustadh Khalid', role: 'Islamic Scholar', icon: 'book-outline', message: 'The Prophet ﷺ said: "A person will not be a true believer until he loves for his brother what he loves for himself." Your future self deserves better than this.' },
  { name: 'Future You (Age 45)', role: 'Your Older Self', icon: 'time-outline', message: 'I\'m writing this from a life of regret. The business never started. The relationships fell apart. All because I couldn\'t put the phone down.' },
  { name: 'Mama', role: 'Your Mother', icon: 'heart-outline', message: 'I didn\'t raise you to be a zombie. I sacrificed everything so you could build something. Not scroll something.' },
];
...
export default function InterventionModal() {
    ...
    return (
      <SafeScreen>
        <Animated.View entering={FadeIn.duration(400)} style={styles.content}>
          ...
          <Ionicons name={person.icon as React.ComponentProps<typeof Ionicons>['name']} size={Sizing.avatarMd} color={Colors.PRIMARY} style={styles.avatarIcon} />
  ...
  return (
      <SafeScreen>
      <Animated.View entering={FadeIn.duration(400)} style={styles.content}>
        <Ionicons name="warning-outline" size={Sizing.avatarMd} color={Colors.DANGER} style={styles.finalIcon} />
        ...
        <Card glass style={styles.optionCard}>
          <Ionicons name="alert-circle-outline" size={48} color={Colors.DANGER} style={styles.optionIcon} />
...
const styles = StyleSheet.create({
  ...
  avatarIcon: { alignSelf: 'center', marginBottom: Spacing.lg },
  ...
  finalIcon: { alignSelf: 'center', marginBottom: Spacing.lg },
